...
class WordCardViewHolder(override val containerView: View) : LayoutContainer,
    ...
    fun showOptions() = animateView(View.GONE, View.GONE, View.VISIBLE)
    fun showPreview() = animateView(View.VISIBLE, View.GONE, View.GONE)
    fun showDescription() = animateView(View.GONE, View.VISIBLE, View.GONE)
